...
partio also supports [Codex](/integrations/codex). By default it auto-detects whichever agent is running — see [Choosing the agent](/cli/configuration#choosing-the-agent).
