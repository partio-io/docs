...
| `stale_session_threshold` | string | `"10m0s"` | How long an ACTIVE/IDLE session file can go without being updated before it is considered stale and cleaned up (e.g. `"10m"`, `"30m"`) |
...
| `PARTIO_STALE_SESSION_THRESHOLD` | `stale_session_threshold` | Duration string (e.g., `"10m"`, `"30m"`) |
